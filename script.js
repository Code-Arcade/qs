...
async function handleAddEntry(event) {
    ...
    try {
        if (editingState) {
            ...
            await handleUpdateEntry(originalSite, originalVendor, siteName, vendorName, woNo, woValue, newAdvances);
        } else {
            await handleCreateEntry(siteName, vendorName, woNo, woValue, newAdvances);
        }
...
async function handleCreateEntry(siteName, vendorName, woNo, woValue, advances) {
...
async function handleUpdateEntry(originalSite, originalVendor, siteName, vendorName, woNo, woValue, advances) {
...
function renderAdminPanel() {
    ...
    contentArea.innerHTML = `
        <div class="table-container">
            <h2 style="margin-bottom: 1.5rem; font-weight: 600;">System Records</h2>
